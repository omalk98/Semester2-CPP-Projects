...
/////////////////////////////////////////////
// the changes to the code have been made to suit the parameter 
// for the templated functions in the searchNList header
#include <iostream>
#include "Car.h"
#include "Employee.h"
#include "ReadWrite.h"
...
int main() {
   ...
   listArrayElements(C, 7, "All the cars:");
   ...
   listArrayElements(S, 6, "All students:");
   ...
   listArrayElements(E, 6, "All employees:");
   ...
   // Title: "INTEGERS"
   listArrayElements(a, 6, "INTEGERS");
   return 0;
}